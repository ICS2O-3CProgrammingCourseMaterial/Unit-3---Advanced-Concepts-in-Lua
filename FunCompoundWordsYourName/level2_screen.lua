...
-- move the button
pauseButton.x = display.contentWidth/30
...
local wordBankLevel1 = { {"Book", "Shelf"}, {"Fork", "Lift"}, {"Some", "Day"}, {"Side", "Kick"}, {"Key", "Pad"}, {"Under", "Dog"}, {"Life", "Time"}, {"Dish", "Cloth"}, {"Grand", "Child"}, {"Fish", "Tail"} }
...
-- initialize colour of words to white
word1:setFillColor( 1, 1, 1 )
word2:setFillColor( 1, 1, 1 )
word3:setFillColor( 1, 1, 1 )
word4:setFillColor( 1, 1, 1 )
word5:setFillColor( 1, 1, 1 )
word6:setFillColor( 1, 1, 1 )
word7:setFillColor( 1, 1, 1 )
word8:setFillColor( 1, 1, 1 )
...
function RemoveWordFromTextObjectSetA()
    ...
    while ( (i <= textObjectListLength) and (wordFound == false) ) do
        ...
        if (userWordSetA == aTextObject.text) then
            aTextObject:setFillColor(1, 1, 1)            
...
function VerifyWordGroup()    
    ...
    if (numWordsCorrect == WORD_LIST_SIZE) then
        ...
        local function nextScene()
            print("enteredscene")
            composer.gotoScene( "beatleveltwo" )
        end
...
function scene:create( event )
    ...
    local bkg_image = display.newImageRect("Images/Level_2.png", display.contentWidth, display.contentHeight)
    bkg_image.x = display.contentCenterX
    bkg_image.y = display.contentCenterY

    -----------------------------------------------------------------------------------------
    --  INITIAL MINERAL POSITION                                                             --
    -----------------------------------------------------------------------------------------
    local CloudImage = display.newImageRect("Images/minerals.png", display.contentWidth/1, display.contentHeight/2.6)
