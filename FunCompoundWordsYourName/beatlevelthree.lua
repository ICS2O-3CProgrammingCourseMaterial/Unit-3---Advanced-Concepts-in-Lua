...
-- Date: Nov. 24th, 2014
-- Description: This is the page that shows after beating the third level
-----------------------------------------------------------------------------------------
...
function scene:create( event )
    ...
    bkg_image = display.newImage("Images/Level_3.png")
   ...
   bkg_image:toBack()
    ...
    function level2Transition( )
        composer.gotoScene( "level4_screen", {effect = "crossFade", time = 300})
    end
    ...
    -----------------------------------------------------------------------------------------
    text = display.newText( "Congratulations! You beat the third level.", display.contentWidth/2, -100, native.systemFont, 30 )
