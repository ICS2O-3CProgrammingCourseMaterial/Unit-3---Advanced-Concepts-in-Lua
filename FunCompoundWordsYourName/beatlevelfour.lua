...
-- Date: Nov. 24th, 2014
-- Description: This is the page that shows after beating the fourth level
-----------------------------------------------------------------------------------------
...
function scene:create( event )
    ...
    bkg_image = display.newImage("Images/Level_4.png")
   ...
   bkg_image:toBack()
    ...
    function winTransition( )
        composer.gotoScene( "winscreen", {effect = "fade", time = 300})
    ...
    -----------------------------------------------------------------------------------------
    text = display.newText( "Congratulations! You beat the fourth level.", display.contentWidth/2, -100, native.systemFont, 30 )
