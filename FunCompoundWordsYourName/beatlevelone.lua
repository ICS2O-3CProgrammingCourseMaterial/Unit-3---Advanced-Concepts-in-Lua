...
-- Date: Nov. 24th, 2014
-- Description: This is the page that shows after beating the first level
-----------------------------------------------------------------------------------------
...
if savedData < 2 then
    ...
    local path2 = system.pathForFile( "currentlevel.txt", system.DocumentsDirectory )
...
function scene:create( event )
    ...
    bkg_image = display.newImage("Images/Level_1.png")
   ...
   bkg_image:toBack()
    ...
    function level2Transition( )
        composer.gotoScene( "level2_screen", {effect = "crossFade", time = 300})
    end
    ...
    -----------------------------------------------------------------------------------------
    cloudImage = display.newImage("Images/Cloudsfinished.png")
    cloudImage.x = display.contentCenterX
    cloudImage.y = 300 
    cloudImage.width = display.contentWidth
    cloudImage.height = display.contentHeight/3
    -----------------------------------------------------------------------------------------

    -----------------------------------------------------------------------------------------
    --  INITIAL TEXT POSITION                                                             --
    -----------------------------------------------------------------------------------------
    text = display.newText( "Congratulations! You beat the first level.", display.contentWidth/2, -100, native.systemFont, 30 )
