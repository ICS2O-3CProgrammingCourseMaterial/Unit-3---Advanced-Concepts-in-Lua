...
local wordBankLevel1 = { {"Fish", "Hook"}, {"Home", "Work"}, {"Fisher", "Man"}, {"Good", "Bye"}, {"Cross", "Walk"}, {"Sky", "Scraper"}, {"Every", "Where"}, {"Pass", "Port"}, {"Skate", "Board"}, {"Ham", "Burger"} }
...
function VerifyWordGroup()    
    ...
    if (numWordsCorrect == WORD_LIST_SIZE) then
        ...
        local function nextScene()
            print("enteredscene")
            composer.gotoScene( "beatlevelfour" )
        end
...
function scene:create( event )
    ...
    local bkg_image = display.newImageRect("Images/Level_4.png", display.contentWidth, display.contentHeight)
